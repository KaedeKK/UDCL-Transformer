...
class CWRModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--dual_CR',type=util.str2bool, nargs='?', const=True, default=True)
    ...
    def compute_G_loss(self):
        ...
        if self.opt.lambda_NCE > 0.0:
            ...
            # self.loss_pixelCR = self.Contrastiveloss(self.fake_B,self.real_A,self.real_B)
        else:
            self.loss_NCE, self.loss_NCE_bd = 0.0, 0.0
        self.loss_NCE_Y = self.Contrastiveloss(self.fake_B, self.real_A, self.real_B)
    ...
    def Contrastiveloss(self, a, p, n):
        a_vgg, p_vgg, n_vgg = vgg_cr(a), vgg_cr(p), vgg_cr(n)
        loss = 0
        l1 = torch.nn.L1Loss()
