...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./datasets/EnGAN/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='EnGAN', help='name of the experiment. It decides where to store samples and models')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cwr', help='chooses which model to use.')
        ...
        parser.add_argument('--netG', type=str, default='PCFormer', choices=['resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat','PCFormer'], help='specify generator architecture')
